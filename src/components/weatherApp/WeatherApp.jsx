...
const WeatherApp = () => {
  ...
  let api_key ="38a7ac3098b0a9aea35363c8747a9378";
  ...
  const handleSearch =  async () => {
    ...
    let url = `https://api.openweathermap.org/data/2.5/weather?q=${element[0].value}&units=Metric&appid=${api_key}`; // need to run in thunder client 
